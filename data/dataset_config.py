...
def return_ucf101(modality):
    ...
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET + '/ucf101/ucf101_jpg256'
        filename_imglist_train = '/data/ucf101/labellist/trainlist1.txt'
        filename_imglist_val = '/data/ucf101/labellist/testlist1.txt'
...
def return_hmdb51(modality):
    ...
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET + '/hmdb51/hmdb51_jpgs'
        filename_imglist_train = '/data1/chengdabing/hmdb51/labellist3/train_rgb_split1.txt'
        filename_imglist_val = '/data1/chengdabing/hmdb51/labellist3/val_rgb_split1.txt'
        prefix = 'image_{:05d}.jpg'
    elif modality == 'Flow':
...
def return_something(modality):
    ...
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET + '/sth_v1/rgb'
        filename_imglist_train = '/data1/chengdabing/sth_v1/split/train_split.txt'
        filename_imglist_val = '/data1/chengdabing/sth_v1/split/val_split.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
